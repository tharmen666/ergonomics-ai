...
export const HRDashboard = () => {
    ...
    const activeCase = selectedCase ? filteredCases.find(c => c.id === selectedCase.id) || null : null;
                        ...
                        >
                            <div className="space-y-8">
                                ...
                                <div className="flex items-center gap-4 bg-white/5 p-4 rounded-2xl border border-white/5">
                                    <div className="w-12 h-12 bg-ohs-orange/20 text-ohs-orange rounded-xl flex items-center justify-center font-black text-lg flex-shrink-0 aspect-square">
