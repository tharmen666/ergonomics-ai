    ...
    return (
        <div className="p-3 sm:p-6 md:p-8 max-w-6xl mx-auto space-y-6 sm:space-y-8 pb-32 font-sans">
            <motion.div
                ...
                className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-white/10 pb-6 gap-4"
            >
                <div className="flex items-center gap-3 sm:gap-4">
                    <div className="bg-ohs-blue/10 p-2.5 sm:p-3 rounded-2xl border border-ohs-blue/20 shrink-0">
                        <Database className="text-ohs-blue w-7 h-7 sm:w-9 sm:h-9" />
                    </div>
                    <div>
                        <h2 className="text-xl sm:text-2xl md:text-3xl font-black text-white tracking-tight uppercase">Master Owner Administration</h2>
                        <p className="text-gray-400 text-xs sm:text-sm font-medium">Aggregate corporate tenants, session logs, and premium assessment ledger metrics.</p>
                    </div>
                </div>
                <div className="flex items-center gap-2 bg-ohs-blue/15 border border-ohs-blue/30 px-3 py-1.5 sm:px-4 sm:py-2 rounded-xl text-ohs-blue text-[10px] sm:text-xs font-black uppercase tracking-wider w-max">
