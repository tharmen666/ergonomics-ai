...
class SemanticFirewall {
    ...
    private shardOHSLogic() {
        ...
        this._ohsCore.set('sec37', {
            ...
            af: "Artikel 37 (Dade/Versuim van Werknemers en Mandatarisse): Werkgewers is middellik aanspreeklik vir die gesondheids- en veiligheidsaksies van hul werknemers."
        });
        ...
        this._ohsCore.set('sec38', {
            ...
            af: "Artikel 38 (Misdrywe en Strawwe – 2026 Wysiging): Nie-nakoming dra nou administratiewe boetes tot 10% van jaarlikse omset."
        });
        ...
        this._ohsCore.set('sec24', {
            ...
            af: "Artikel 24 (Aanmelding van Voorvalle): Alle werksplekvoorvalle moet binne 7 dae by die Departement van Indiensneming en Arbeid aangemeld word."
        });
    }
    ...
    private shardISOLogic() {
        this._isoCore.set('9001-2015', {
            ...
            af: "ISO 9001:2015 (Kwaliteitbestuurstelsels): Vereis organisasies om 'n prosesgebaseerde benadering te aanvaar met bewyse van voortdurende verbetering."
        });
        ...
        this._isoCore.set('14001-2015', {
            ...
            af: "ISO 14001:2015 (Omgewingsbestuurstelsels): Klousule 8.1 vereis operasionele kontroles vir beduidende omgewingsaspekte."
        });
        ...
        this._isoCore.set('45001-2018', {
            ...
            af: "ISO 45001:2018 (Beroepsgesondheid en Veiligheidsbestuur): Vereis 'n proaktiewe benadering tot risikobestuur en verpligte werkersdeelname."
        });
        ...
        this._isoCore.set('45003-2021', {
            ...
            af: "ISO 45003:2021 (Sielkundige Gesondheid en Veiligheid by die Werk): Die eerste globale standaard vir die bestuur van psigososiale risiko's soos uitbranding."
        });
    }
