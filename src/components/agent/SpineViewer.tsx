    ...
    useFrame((state, delta) => {
        ...
        if (groupRef.current) {
            ...
            groupRef.current.children.forEach((child: any, i: number) => {
                ...
                child.position.z = (THREE as any).MathUtils.lerp(child.position.z, -zOffset, delta * 16);
                child.rotation.x = (THREE as any).MathUtils.lerp(child.rotation.x, -pitch, delta * 16);
